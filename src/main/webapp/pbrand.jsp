...
<script type="text/javascript">
	function getList() {
		document.forms[0].action = "pbrand";
					...
					<form action="" method="post">
						<div class="layui-inline">
							<div class="layui-input-inline">
								<input value="${bname }" name="bname" placeholder="请输入关键字"
							...
							<div class="layui-input-inline">
								...
								<select
									id="ptid" name="ptid" class="form-control">
						...
						<div class="layui-inline">
							 <a href="listPbtype"
								class="layui-btn layui-btn-normal newsAdd_btn">添加类型</a> 
						</div>
							...
							<tbody>
								...
								<c:forEach items="${list }" var="p" varStatus="statu">
									<tr>
										...
										<td><a href="delete?pbid=${p.pbid}"
											class="btn btn-default ">删除</a>
											<a href="updateType?pbid=${p.pbid }"
