...
<script type="text/javascript">
	function add() {
		document.forms[0].action = "savePbrand";
			...
			<form class="layui-form col-lg-5" action="" method="post">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
						<input type="text" name="pbname"  autocomplete="off"  class="layui-input" value=""  >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="pbadd"  autocomplete="off" class="layui-input" value="" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="pbphone"  autocomplete="off" class="layui-input" value="">
					</div>
				</div>
